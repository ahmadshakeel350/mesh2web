<?php echo view('db_head'); ?>
    ...
    <div class="row">
      ...
      <div class="col-lg-10 mt-4">
        <div class="container">
          <div class="row">
            <div class="col-sm-4">
              <form class="mb-3" action="" id="video_template_form" enctype="multipart/form-data"  method="POST" autocomplete="off">
	...
	<script>
		...
		function sendUpdate(pname)
		{
			...
			message.destinationName = "/signage/vid/"+tid;
			mqtt.send(message);
		}
		
		$("#video_template_form").on("submit", function(e) {
            e.preventDefault();
            ...
            $.ajax({
              ...
              success: function (data) {
                  if(tid==='none')
                  {
                      ...
                      document.getElementById('display_screen').src = "<?= base_url(); ?>/vid/"+tid;
        		  }
                  var sp = document.getElementById("spinner");
